...
import { CheckCircle2, ArrowRight, Chrome, Mail } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-1.5 text-sm font-medium text-emerald-700 mb-6 border border-emerald-200 shadow-sm animate-in fade-in zoom-in duration-500">
        ...
        <Card className="border-slate-200 shadow-xl overflow-hidden">
          ...
          <CardContent className="space-y-4 pt-4">
            ...
            <Button className="w-full h-12 text-base font-bold bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-500/20" onClick={handleGoogleLogin}>
